          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-text-muted max-w-xl mx-auto leading-relaxed">
                ...
                as soon as possible. A confirmation has also been sent to your
                email.
              </p>
            ...
            <div className="max-w-2xl mx-auto rounded-lg border border-border-soft bg-input-surface/40 px-6 py-8 text-center mb-10">
              ...
              <p className="text-text-muted leading-relaxed">
                Call or message us on WhatsApp — you can also send photos so we
                can size up the job quickly.
              </p>
